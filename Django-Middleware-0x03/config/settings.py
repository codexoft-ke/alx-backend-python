...
SECRET_KEY = 'django-insecure-kwd+kk&a!yctj2qd+9!*z1@&96xr=_=zm3bo$n^vti9n%iy%51'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'apps.chats.permissions.IsParticipantOfConversation',
    ],
...
ALLOWED_IPS = None  # Set to a set of IPs to enable whitelist mode
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'middleware.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
